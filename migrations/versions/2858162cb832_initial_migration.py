...
Revision ID: 2858162cb832
Revises: 
Create Date: 2025-04-29 15:42:23.919736
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['game_history_id'], ['game_history.id'], ondelete='CASCADE'),
